        ...
        <ul className="flex h-[3rem] items-center justify-between uppercase tracking-wider">
          ...
          <li className="h-full ">
            <button
              ...
              className={` 
            flex h-full  items-center justify-center rounded-sm px-4 text-secondary transition-all duration-200 ease-in-out hover:scale-105 hover:bg-secondary hover:text-primary`}
            >
              <FiLogOut />
            </button>
          </li>
